...
//  Printing();
    ...
    while(Timer_3_Div<1000)                   // motor 1 sec via de relais op volle kracht opstarten
    {
        ...
        checkUdpIncomming();                    // keep the device response to mobile commands while in test
        Timer_3_New=millis();
        Timer_3_Div=(Timer_3_New-Timer_3_Old); 
...
//  }
    ...
    VentOn = true;
    broadcastUdpState();                                // ventilator state has changed, let any possible mobiles know about this
}
