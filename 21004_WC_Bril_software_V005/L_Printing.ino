...
//====================================================================
  ...
  if ((Led1==1) and (Led2==1) and (Led3==1) and (Led4==0))
  {
    Serial.println("< 75%");
  }
  if ((Led1==1) and (Led2==1) and (Led3==0) and (Led4==0))
  {
    Serial.println("< 50%");
  }
  if ((Led1==1) and (Led2==0) and (Led3==0) and (Led4==0))
  { 
    Serial.println("< 25%");
  }
  if ((Led1==0) and (Led2==0) and (Led3==0) and (Led4==0))
  { 
...
//==================================================================== 
  Serial.print("Filter reeds in weking min = ...... ");
